...
```{r}
corr <- cor(df[c("latitude", "Elevation", "RainMAP", "TempMAT", "ndep_2016", "Richness", "FractionExotic", "PhenoTrendXyr_sos_slope","PhenoTrendXyr_eos_slope","PhenoTrendXyr_gsl_slope", "PhenoTrendXyr_maxndvi_slope",  "TempTrend36yr_5mo_max_slope", "PrecipTrend36yr_2mo_sos_slope")])
